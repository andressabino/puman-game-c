 PUMAN — El Explorador de la Universidad

Un videojuego interactivo en consola desarrollado en C puro, donde el jugador controla a la mascota de la universidad (Pingüino) para recolectar créditos académicos mientras escapa de tiburones hambrientos.
...
Temas: `grafos`, `TAD Cola (Queue)`, `BFS`, `búsqueda de rutas`
